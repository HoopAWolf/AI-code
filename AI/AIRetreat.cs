...
public class AIRetreat : AIBase {
    ...
    public AIRetreat(int _priority, EntityLivingBase _entity, System.Type _type, float _range)
    {
        f_range = _range;
        ...
        type_target = _type;
        s_ID = "Movement";
        s_display_name = "Retreat From Target - " + type_target;
    ...
    public override bool ShouldContinueAI()
    {
        ...
        if ((ent_main.GetPosition().x > ent_target.GetPosition().x - 1 && ent_main.GetPosition().x < ent_target.GetPosition().x + 1
            &&
            ent_main.GetPosition().z > ent_target.GetPosition().z - 1 && ent_main.GetPosition().z < ent_target.GetPosition().z + 1)
            || !(ent_main.GetPosition().x > ent_target.GetPosition().x - f_range && ent_main.GetPosition().x < ent_target.GetPosition().x + f_range
            &&
        ...
        ent_main.GetAnimator().SetBool("Walk Backward", true);
    ...
    {
        ent_main.GetAnimator().SetBool("Walk Backward", false);
