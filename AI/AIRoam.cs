...
public class AIRoam : AIBase {
    ...
    {
        if((ent_main.GetPosition().x > v3_target_position.x - 2 && ent_main.GetPosition().x < v3_target_position.x + 2
            &&
            ent_main.GetPosition().z > v3_target_position.z - 2 && ent_main.GetPosition().z < v3_target_position.z + 2) 
